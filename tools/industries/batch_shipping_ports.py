    ...
    'shipping_ports': {
        ...
        "top": top_band(
            ...
            [uc("Berth Productivity", "Vessel ops", "gauge", "Crane moves per hour and berth idle time attributed to plan versus execution.",
                ...
                how="Navis N4 TOS moves and Kalmar crane telemetry land through Lakeflow and conform on Delta Lake, so berth productivity is attributed to plan versus execution and read in the Berth Planner.",
                comps=["Berth Planner", "Navis N4 TOS", "Kalmar Terminal Vision", "Lakeflow", "Delta Lake", "AI/BI"],
                stories=[
             ...
             uc("Crane Sequencing", "Equipment", "iot", "Crane work lists optimised for twin-lift and minimum rehandle.",
                ...
                comps=["Berth Planner", "Navis N4 TOS", "Kalmar Terminal Vision", "Model Serving", "Delta Lake", "Apache Spark"]),
             ...
             uc("Tariff & Storage Revenue", "Commercial", "market", "Handling and storage charges reconciled to actual moves.",
                ...
                how="Oracle Port Billing and HPH Tariff Engine data conform on Delta Lake and reconcile to actual crane and gate events, so handling and storage revenue is verified on certified AI/BI views.",
                comps=["Oracle Port Billing", "HPH Tariff Engine", "Navis N4 TOS", "Delta Lake", "AI/BI", "Unity Catalog"],
                stories=[
             ...
             uc("Environmental Reporting", "ESG", "chart", "Emissions and noise metrics reported to port authority programs.",
                ...
                comps=["AIS Vessel Tracking", "Kalmar Terminal Vision", "Unity Catalog", "Delta Lake", "AI/BI", "Data Products"],
                stories=[
