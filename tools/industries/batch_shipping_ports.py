        ...
        "top": top_band(
            ...
            [uc("Berth Productivity", "Vessel ops", "gauge", "Crane moves per hour and berth idle time attributed to plan versus execution.",
             ...
             uc("Intermodal Rail Load", "Rail", "partner", "Train loading plans matched to vessel discharge and yard slots.",
                ...
                who="Landside Logistics",
                how="TOS discharge events and SAP TM rail orders conform on Delta Lake, so load plans in the Gate Optimizer are matched to actual discharge and yard slots and shared to the ramp over OpenSharing.",
                comps=["Gate Optimizer", "SAP TM for Ports", "Navis N4 TOS", "Delta Lake", "OpenSharing", "AI/BI"]),
