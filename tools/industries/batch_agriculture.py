        ...
        "top": top_band(
            ...
            [uc("Yield Forecasting", "Production", "chart", "In-season yield estimates from imagery, weather and hybrid response.",
             ...
             uc("Supply Chain Traceability", "Traceability", "product", "Lot lineage from field through elevator to customer.",
                ...
                who="Sustainability",
                how="Field, elevator and ERP data are conformed under Unity Catalog and published as governed data products shared to food-company buyers and lenders over OpenSharing.",
                comps=["SAP S/4HANA Agribusiness", "Unity Catalog", "Data Products", "OpenSharing", "Delta Lake"],
