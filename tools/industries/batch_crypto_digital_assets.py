    ...
    "crypto_digital_assets": {
        ...
        "rails": {
            "src": [
                {
                    ...
                    "tiles": [
                        tile(
                            ...
                            "alchemy",
                            cat="Blockchain Node / RPC Provider",
                            what="Managed node and RPC access across Ethereum, Layer-2s and other chains, the source of block, transaction and log data without running the full node estate in-house.",
                            users="Blockchain engineering, data engineering and quant.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Blocks + logs + traces", "Continuous (per block)")),
                        ),
                        tile(
                            "Infura RPC",
                            "network",
                            ...
                            "infura",
                            cat="Blockchain Node / RPC Provider",
                            what="Node infrastructure serving JSON-RPC and WebSocket access to Ethereum and IPFS, a redundant path for on-chain reads and transaction broadcast.",
                            users="Blockchain engineering and data engineering.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Blocks + logs", "Continuous (per block)")),
                        ),
                        tile(
                            "The Graph Indexer",
                            "spark",
                            ...
                            "thegraph",
                            cat="Blockchain Indexing Protocol",
                            what="Subgraph indexing of smart-contract events into queryable entities, the decoded protocol-level view of DeFi and token activity across chains.",
                            users="Blockchain engineering, quant and DeFi analytics.",
                            data_out=data_out(
                                batch=flow(["semi-structured"], "Decoded contract entities", "Continuous indexing"),
                                stream=flow(["semi-structured"], "Subgraph event updates", "Near real-time")),
                        ),
                        tile(
                            "QuickNode Streams",
                            "stream",
                            ...
                            "quicknode",
                            cat="Blockchain Node / Streaming Provider",
                            what="Low-latency node access and streaming of blocks, mempool and contract events, the real-time on-chain feed for trading and surveillance.",
                            users="Trading, market surveillance and blockchain engineering.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Blocks + mempool + events", "Continuous (real-time)")),
                        ),
                    ],
                },
                {
                    ...
                    "tiles": [
                        tile(
                            ...
                            "alphapoint",
                            cat="Digital-Asset Exchange / Matching Engine",
                            what="Digital-asset exchange and matching-engine platform carrying order books, trade execution and inventory, the system of record for on-venue trading.",
                            users="Trading operations, market makers and market data.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Order + trade events at peak", "Continuous (real-time)")),
                        ),
                        tile(
                            "Kaiko Market Data",
                            "market",
                            ...
                            "kaiko",
                            cat="Crypto Market Data Provider",
                            what="Institutional crypto market data covering trades, order books and reference rates across centralised and decentralised venues, the benchmark feed for liquidity and pricing analytics.",
                            users="Market data, trading desk and quant.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Trades + order-book ticks", "Continuous (real-time)"),
                        ...
                        tile(
                            ...
                            "coingecko",
                            cat="Crypto Price / Metadata API",
                            what="Broad price, volume and asset-metadata coverage across thousands of tokens and venues, used for market context and coverage checks.",
                            users="Market data, trading and research.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Prices + volumes", "Continuous (API polling)"),
                                batch=flow(["structured"], "Asset metadata", "Daily refresh")),
                        ),
                        tile(
                            "CF Benchmarks",
                            "market",
                            ...
                            "cfbenchmarks",
                            cat="Benchmark / Reference Rate Provider",
                            what="Regulated crypto reference rates and indices, including the underlying rates for listed crypto futures and ETFs, the reference against which marks and settlements are validated.",
                            users="Risk, finance and trading desk.",
                            data_out=data_out(
                                batch=flow(["structured"], "Reference rates + index levels", "Continuous fixings, batch load")),
                        ),
                    ],
                },
                {
                    ...
                    "tiles": [
                        tile(
                            ...
                            "fireblocks",
                            cat="Digital-Asset Custody (MPC Wallet)",
                            what="MPC-based wallet infrastructure and transfer policy engine carrying key shares, whitelists and signed withdrawals, the source of truth for custodied balances and movement.",
                            users="Custody operations, wallet security and treasury.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Transfer + approval events", "Continuous (events)"),
                                batch=flow(["structured"], "Balance + policy snapshots", "Nightly reconciliation")),
                        ),
                        tile(
                            "BitGo Custody",
                            "key",
                            ...
                            "bitgo",
                            cat="Qualified Digital-Asset Custody",
                            what="Qualified custody and multi-signature wallets with settlement and staking, the record of institutional holdings and their approval workflow.",
                            users="Custody operations, wallet security and finance.",
                            data_out=data_out(
                                batch=flow(["structured"], "Holdings + approval records", "Nightly reconciliation"),
                                stream=flow(["semi-structured"], "Transfer events", "Continuous (events)")),
                        ),
                        tile(
                            "Ledger Enterprise",
                            "key",
                            ...
                            "ledger",
                            cat="Hardware Custody / Key Management",
                            what="Hardware-secured enterprise custody and key management, the governed device layer behind cold-storage balances and withdrawal ceremonies.",
                            users="Wallet security, custody operations and audit.",
                            data_out=data_out(
                                batch=flow(["structured", "semi-structured"], "Key ceremony + device logs", "Nightly batch")),
                        ),
                        tile(
                            "Copper Custody",
                            "key",
                            ...
                            "copper",
                            cat="Custody & Off-Exchange Settlement",
                            what="Custody, collateral and off-exchange settlement for institutions, the record of segregated holdings pledged against trading exposure.",
                            users="Custody operations, treasury and credit risk.",
                            data_out=data_out(
                                batch=flow(["structured"], "Collateral + settlement records", "Nightly reconciliation"),
                                stream=flow(["semi-structured"], "Settlement events", "Continuous (events)")),
                        ),
                    ],
                },
                {
                    ...
                    "tiles": [
                        tile(
                            ...
                            "chainalysis",
                            cat="Blockchain Analytics / KYT",
                            what="Know-Your-Transaction screening and address risk scoring across chains, the wallet and transaction risk signal every AML disposition is built on.",
                            users="MLRO and financial crime, sanctions and investigations.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Screening API responses", "Continuous (API)"),
                                batch=flow(["structured"], "Risk scores + exposure paths", "Daily batch")),
                        ),
                        tile(
                            "Elliptic Analytics",
                            "zshield",
                            ...
                            "elliptic",
                            cat="Blockchain Analytics / Screening",
                            what="Blockchain analytics and exposure tracing for digital-asset compliance, the source of wallet risk, exposure paths and illicit-activity indicators.",
                            users="Financial crime, sanctions and investigations.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Screening API responses", "Continuous (API)"),
                                batch=flow(["structured"], "Risk + exposure data", "Daily batch")),
                        ),
                        tile(
                            "TRM Labs",
                            "globe",
                            ...
                            "trm",
                            cat="Blockchain Intelligence / Screening",
                            what="Blockchain intelligence for transaction monitoring, sanctions and investigation, a second risk feed enriched onto addresses and counterparties.",
                            users="Financial crime, sanctions and investigations.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Screening API responses", "Continuous (API)"),
                                batch=flow(["structured"], "Address risk data", "Daily batch")),
                        ),
                        tile(
                            ...
                            "notabene",
                            cat="Travel Rule Compliance Provider",
                            what="FATF Travel Rule messaging exchanging originator and beneficiary information with counterparty VASPs on qualifying transfers, the compliance layer over on-chain settlement.",
                            users="Travel Rule team, compliance and financial crime.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Travel Rule messages", "Continuous (per transfer)")),
                        ),
                    ],
                },
                {
                    ...
                    "tiles": [
                        tile(
                            ...
                            cat="Core Ledger / Accounting System",
                            what="The internal double-entry ledger of customer balances, fees and internal transfers, the accounting record every on-chain balance is reconciled against.",
                            users="Finance, treasury and custody operations.",
                            data_out=data_out(
                                batch=flow(["structured"], "Postings + balances", "Continuous CDC (near real-time)")),
                        ),
                        tile(
                            "Circle / USDC",
                            "product",
                            ...
                            "circle",
                            cat="Stablecoin Issuer / Settlement Rail",
                            what="Stablecoin issuance, minting and redemption flows, the fiat-backed settlement rail whose reserves and movements feed treasury and liquidity.",
                            users="Treasury, finance and settlement operations.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Mint + redeem + transfer events", "Continuous (on-chain)"),
                                batch=flow(["structured"], "Reserve + attestation data", "Daily/periodic")),
                        ),
                        tile(
                            "Fireblocks Network",
                            "partner",
                            ...
                            "fireblocks",
                            cat="Off-Exchange Settlement Network",
                            what="Off-exchange settlement and transfer network between counterparties, the record of institutional settlement instructions and confirmations.",
                            users="Settlement operations, treasury and trading.",
                            data_out=data_out(
                                stream=flow(["semi-structured"], "Settlement instructions + confirmations", "Continuous (events)")),
                        ),
                        tile(
                            "Fedwire / SWIFT",
                            "erp",
                            ...
                            "swift",
                            cat="Fiat Payment / Banking Rail",
                            what="Fiat banking rails for deposits, withdrawals and settlement with partner banks, reconciled against crypto movement for the full cash and coin position.",
                            users="Treasury, settlement operations and finance.",
                            data_out=data_out(
                                batch=flow(["structured", "semi-structured"], "Payment messages + statements", "Multiple settlement cycles daily")),
                        ),
                    ],
                },
                fed_group(
                    ...
                    cat="Finance & Risk Data Mart",
                    what="Finance, treasury and risk marts kept in the incumbent warehouses and queried in place, so audited books and risk exposures enrich analytics without a second copy.",
                    users="Finance, treasury and risk.",
                    data_out=data_out(
                        batch=flow(["structured"], "TB-scale books + risk history", "Queried on demand (federated)")),
                ),
            ],
            "ing": ing_rail(
                [
                    tile(
                        ...
                        "kafka",
                        cat="Event Streaming Bus",
                        what="Exchange order, trade and account events carried on existing Kafka topics, consumed continuously for near-real-time risk and surveillance.",
                        users="Data engineering, risk and market surveillance.",
                        data_out=data_out(
                            stream=flow(["semi-structured"], "Order + trade + account events", "Continuous (real-time)")),
                    ),
                    tile(
                        "Node RPC Streams",
                        "stream",
                        ...
                        cat="On-Chain Streaming Feed",
                        what="Block, mempool and decoded contract events streamed from node and indexer endpoints, landed as governed on-chain tables without bespoke per-chain plumbing.",
                        users="Blockchain engineering, trading and surveillance.",
                        data_out=data_out(
                            stream=flow(["semi-structured"], "Blocks + mempool + events", "Continuous (real-time)")),
                    ),
                    tile(
                        ...
                        "fix",
                        cat="Market Data / Execution Protocol",
                        what="FIX and WebSocket market-data and execution feeds from venues and prime brokers, parsed on arrival and conformed to the same trade and quote entities.",
                        users="Market data, trading operations and data engineering.",
                        data_out=data_out(
                            stream=flow(["semi-structured"], "Quote + execution messages", "Continuous (real-time)")),
                    ),
                ]
            ),
            "ppl": ppl2(
            ...
            "cons": cons_rail(
                ...
                genie_spaces=[
                    genie("Market & Liquidity", "Ask about trading volume, order-book depth and liquidity across venues in plain language.",
                          feeds=["Kaiko Market Data", "AlphaPoint Exchange", "Risk, liquidity, compliance"],
                          teams=["Trading Desk", "Market makers", "Market data"],
                          questions=[
                              "What was trading volume by pair and venue yesterday?",
                              "Where is order-book depth thinnest across our pairs right now?",
                              "How have spreads moved this week by venue?",
                              "Which venues show the best liquidity for a large order?",
                              "How does our market share compare across pairs this month?"]),
                    genie("AML & Wallet Risk", "Ask about wallet risk, exposure paths and alert queues across chains in plain language.",
                          feeds=["Chainalysis KYT", "Elliptic Analytics", "Conformed wallet, asset, trade"],
                          teams=["Compliance & AML", "MLRO & financial crime", "Sanctions & PEP"],
                          questions=[
                              "Which wallets show the highest risk exposure this week?",
                              "What is a wallet's exposure path to sanctioned addresses?",
                              "How large is the AML alert backlog and what is ageing?",
                              "Which counterparties have rising illicit-activity indicators?",
                              "How many transfers were held or blocked for screening today?"]),
                    genie("Custody & Reserves", "Ask about custodied balances, reconciliation and proof of reserves in plain language.",
                          feeds=["Fireblocks Custody", "Core Ledger", "Conformed wallet, asset, trade"],
                          teams=["Custody Ops", "Custody operations", "Proof of reserves"],
                          questions=[
                              "What are our custodied balances by asset right now?",
                              "Where do on-chain balances diverge from the ledger?",
                              "Which withdrawals are pending approval and for how long?",
                              "What is our reserve coverage ratio by asset today?",
                              "How many reconciliation breaks are open across wallets?"]),
                    genie("Treasury & Exposure", "Ask about liquidity, stablecoin reserves and counterparty exposure in plain language.",
                          feeds=["Circle / USDC", "Core Ledger", "Risk, liquidity, compliance"],
                          teams=["Exec & Finance", "CFO & Treasury", "Chief Risk Officer"],
                          questions=[
                              "What is our fiat and crypto liquidity across venues and banks?",
                              "How much stablecoin reserve backing do we hold right now?",
                              "Which counterparties carry the largest exposure today?",
                              "What settlement float is expected before the next window?",
                              "What was net trading revenue yesterday across the book?"]),
                ],
                dashboards=[
                    dashboard("Trading & Liquidity", "Volume, depth and liquidity across venues and pairs on certified Metric Views.",
                              kpis=["Trading volume", "Order-book depth", "Spread", "PnL", "Market share"],
                              teams=["Trading Desk", "Market makers", "Trading operations"]),
                    dashboard("AML & Surveillance", "Wallet risk, alert queues and surveillance posture across the book.",
                              kpis=["Alert volume", "High-risk wallet exposure", "SAR filings", "False-positive rate", "Sanctions hits"],
                              teams=["Compliance & AML", "Risk & Fraud", "MLRO & financial crime"]),
                    dashboard("Custody & Proof of Reserves", "Custodied balances, reconciliation and reserve assurance across wallets.",
                              kpis=["Custodied balances", "On-chain vs ledger variance", "Withdrawal approvals", "Reserve coverage ratio", "Reconciliation breaks"],
                              teams=["Custody Ops", "Custody operations", "Proof of reserves"]),
                    dashboard("Treasury & Risk", "Liquidity, reserves and counterparty exposure across venues and banks.",
                              kpis=["Liquidity buffer", "Stablecoin reserves", "Counterparty exposure", "Settlement float", "Net exposure"],
                              teams=["Exec & Finance", "CFO & Treasury", "Chief Risk Officer"]),
                ],
            ),
        },
